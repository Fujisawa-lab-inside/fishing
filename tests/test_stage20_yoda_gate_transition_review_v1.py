...
class TransitionReviewTests(unittest.TestCase):
    ...
    def test_04_generates_auditable_review_without_gate_label(self) -> None:
        with tempfile.TemporaryDirectory() as temporary:
            ...
            self.assertTrue((output / "per-gate-rotating-lamp-review.png").is_file())
            ...
            self.assertEqual(report["perGateRotatingLampReview"]["gateOrderNearToFar"], review.EXPECTED_GATE_IDS)
