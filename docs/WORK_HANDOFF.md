...
## Stage 20 barrage holdout recovery result (2026-07-17)

- The explicitly authorized one-time recovery completed successfully in GitHub Actions run `29511898671` on execution commit `92fd709ba4b8760c35b203649e5a0bf00904cdc5`.
- All five downloaded artifacts passed exact-inventory and SHA-256 validation. The five-link restart chain, nine new snapshots, retained open-barrage `-12 h` snapshot, and exact ten-snapshot endpoint set were verified.
- Every recovery segment passed the numerical checks: maximum CFL `0.12000000000000001`, maximum relative mass-balance error `5.390327755611793e-13`, non-finite count zero, and negative-depth count zero.
- The 50:50 endpoint midpoint was compared with the direct 50% reference S02 for five hours and four fixed regions. The evidence was fully evaluable, but only 5 of 20 comparisons passed; all five passes were in the 曲川・遠賀川 confluence region.
- The full estuary, barrage, and fishway failed at every hour. Worst velocity-vector RMSE was `0.02766268977037687 m/s`, worst direction p95 error was `162.19096100669907°`, worst depth RMSE was `3.5213067614156484 m`, and maximum absolute depth error was `5.060152317037159 m`.
