...
self.addEventListener('message', async event => {
  ...
  try {
    ...
    const message = {
      ...
      responsePackVersion: pack.manifest.version,
      meshManifest: pack.manifest.mesh.manifest,
      meshSchema: pack.manifest.mesh.schema,
      meshVersion: pack.manifest.mesh.version,
