...
- No production-mesh numerical case, physical Validation claim, external contact, public simulator connection, automatic retry, `main` merge, or additional run is currently enabled.
