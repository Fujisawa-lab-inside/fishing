...
- The next visual decision is whether to adopt this comparison result and prepare only a cross-condition holdout-test plan. No additional physical run, S03, remaining segment, public connection, or `main` merge is authorized.
