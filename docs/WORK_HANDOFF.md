...
- The next visual decision is whether to adopt S02 as the direct-solver reference and prepare a browser-interpolation/error-map comparison without another physical run.
