...
const checks = [
  ...
  check('production mesh audit no longer appears as a data gap',
    packet.dataGaps.includes('audited production mesh'), false,
    !packet.dataGaps.includes('audited production mesh')),
